        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (var i = 0; i <= limit; i++) {
                    ...
                    html += "<img id=carIMG" + i + " alt='Image of car' class='carIage'/>"
                    html += "</div>";
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (var i = 0; i <= limit; i++) {
                    ...
                    html += "<div class='carVisual'>";
                    html += "<h3>" + car.make + " " + car.model + "</h3>";
                    html += "<img id=carIMG" + (i + limit) + " alt='Image of car' class='carIage'/>"
                    html += "</div>";
                    html += "<div class='carInfo'>";
                    html += "<h3>Year - " + car.year_from + "</h3>";
                    html += "<h3>Brand - " + car.make + "</h3>";
                    ...
                    html += "<h3>Top speed - " + car.max_speed_km_per_h + "km/h</h3>";
                    $(".cars").append(html);
                    loadIMg(car.make, car.model, (i + limit));
                }
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (var i = 0; i <= limit; i++) {
                    ...
                    html += "<div class='carVisual'>";
                    html += "<h3>" + car.make + " " + car.model + "</h3>";
                    html += "<img id=carIMG" + (i + limit * 2) + " alt='Image of car' class='carIage'/>"
                    html += "</div>";
                    html += "<div class='carInfo'>";
                    html += "<h3>Year - " + car.year_from + "</h3>";
                    html += "<h3>Brand - " + car.make + "</h3>";
                    ...
                    html += "<h3>Top speed - " + car.max_speed_km_per_h + "km/h</h3>";
                    $(".cars").append(html);
                    loadIMg(car.make, car.model, (i + limit * 2));
                }
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (var i = 0; i <= limit; i++) {
                    ...
                    html += "<div class='carVisual'>";
                    html += "<h3>" + car.make + " " + car.model + "</h3>";
                    html += "<img id=carIMG" + (i + limit * 3) + " alt='Image of car' class='carIage'/>"
                    html += "</div>";
                    html += "<div class='carInfo'>";
                    html += "<h3>Year - " + car.year_from + "</h3>";
                    html += "<h3>Brand - " + car.make + "</h3>";
                    ...
                    html += "<h3>Top speed - " + car.max_speed_km_per_h + "km/h</h3>";
                    $(".cars").append(html);
                    loadIMg(car.make, car.model, (i + limit * 3));
                }
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (var i = 0; i <= limit; i++) {
                    ...
                    html += "<div class='carVisual'>";
                    html += "<h3>" + car.make + " " + car.model + "</h3>";
                    html += "<img id=carIMG" + (i + limit * 4) + " alt='Image of car' class='carImage'/>"
                    html += "</div>";
                    html += "<div class='carInfo'>";
                    html += "<h3>Year - " + car.year_from + "</h3>";
                    html += "<h3>Brand - " + car.make + "</h3>";
                    ...
                    html += "<h3>Top speed - " + car.max_speed_km_per_h + "km/h</h3>";
                    $(".cars").append(html);
                    loadIMg(car.make, car.model, i + limit * 4);
                }
    ...
    xhttp.onload = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (var i = 0; i < response.data.length; i++) {
                ...
                html += "<div class='carVisual'>";
                html += "<h3>" + car.make + " " + car.model + "</h3>";
                html += "<img id=carIMG" + i + " alt='Image of car' class='carImage'/>"
                html += "</div>";
                html += "<div class='carInfo'>";
                html += "<h3>Year - " + car.year_from + "</h3>";
                html += "<h3>Brand - " + car.make + "</h3>";
